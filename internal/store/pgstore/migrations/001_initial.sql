...
-- Every change Argus made in Jira or Confluence. The tool can reassign a
-- ticket, change its points, log work and publish a page; anything that
-- alters someone else's data should leave a record of what it altered.
